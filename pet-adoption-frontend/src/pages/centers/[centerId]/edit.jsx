...
export default function EditProfilePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateCenter(formData, profileImage, bannerImage, centerId)
        .then((centerId) => {
            ...
            <Stack direction="column" >
              <Card sx={{ width: "60vw", p: "15px" }} >
                <form id="Form" onSubmit={handleSubmit}>
                  ...
                  <TextField required fullWidth multiline label='Descripion' name="description" size="small" margin="dense" value={formData.description} onChange={handleChange} />
